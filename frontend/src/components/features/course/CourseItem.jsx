const CourseItem = ({ course }) => {
    return (
        <div className="bg-white border border-gray-200 rounded-2xl p-6 flex flex-col justify-between shadow-sm hover:shadow-md transition-all duration-300 transform transition-all duration-300 hover:-translate-y-1.5">
            <div>
