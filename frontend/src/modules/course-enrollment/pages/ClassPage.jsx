    ...
    return (
      <div className="flex-grow flex items-center justify-center min-h-[500px]">
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-sm font-semibold text-neutral-medium">Đang tải thông tin lớp học...</span>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-[1280px] mx-auto w-full px-4 md:px-8 py-8 flex-grow">
        ...
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-neutral-medium">
              Cập nhật các hoạt động mới nhất của {classData.cohortName || "Lớp học"}.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-6">
          ...
          <div className="lg:col-span-7">
            {isWaitlist ? (
              <PreCourseMaterials materials={classData.preCourseMaterials} />
            ) : (
              <ClassFeed feed={classData.activeFeed} onReactionClick={addReaction} />
            )}
          </div>
          ...
          <div className="lg:col-span-3">
            {isWaitlist ? (
              ...
              <ClassPersonnel pairs={classData.activePersonnel} onFindBuddy={findStudyBuddy} />
            )}
          </div>
        </div>
      </div>
