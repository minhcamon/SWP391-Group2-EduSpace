    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {materials.map((doc) => (
          <article
            key={doc.id}
            className="bg-white p-6 rounded-2xl border border-border-light/30 shadow-sm hover:translate-y-[-2px] hover:shadow-md transition-all duration-200 flex flex-col justify-between"
          >
            <div>
