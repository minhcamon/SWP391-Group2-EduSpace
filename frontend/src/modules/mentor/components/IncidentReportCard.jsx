  ...
  return (
    <Card className="border border-border-light/35 shadow-sm">
      <CardHeader className="border-b border-border-light/20 pb-4">
        <CardTitle className="text-base font-bold text-neutral-dark">Chi tiết nội dung báo cáo</CardTitle>
      </CardHeader>
      <CardContent className="p-6 space-y-4">
        ...
        <div className="space-y-2">
          <p className="text-xs text-neutral-medium font-bold uppercase tracking-wider">Lý do báo cáo</p>
