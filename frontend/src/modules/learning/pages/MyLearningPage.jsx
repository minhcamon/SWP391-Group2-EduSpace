...
const MyLearningPage = () => {
    ...
    return (
      <div className="min-h-[60vh] w-full flex items-center justify-center bg-bg-base">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm font-semibold text-neutral-medium">Đang tải thông tin học tập của bạn...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <main className="flex-1 p-6 md:p-10 max-w-400 mx-auto w-full space-y-10">
      {/* Hero Section */}
      <MyLearningHero />
