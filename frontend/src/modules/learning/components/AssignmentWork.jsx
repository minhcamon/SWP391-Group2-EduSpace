      ...
      <div className='lg:col-span-6 bg-white rounded-2xl p-6 border border-border-light/30 shadow-xs flex flex-col gap-5'>
        ...
        <div className='bg-bg-base/70 p-4 rounded-xl border border-border-light/20'>
          <p className='text-sm text-neutral-medium font-medium leading-relaxed'>
            <strong>Đề bài:</strong> {assignmentDetails?.description}
          </p>
        </div>

        {isSubmitted && (
          <div className='bg-emerald-50 border border-emerald-200/50 rounded-xl p-4 flex items-start gap-3'>
            <CheckCircle className='w-5 h-5 text-emerald-600 shrink-0 mt-0.5' />
            <div>
              <h4 className='text-sm font-bold text-emerald-950'>Đã nộp bài viết thành công</h4>
              <p className='text-xs text-emerald-700 leading-normal mt-0.5'>
                Bài làm của bạn đã được ghi nhận trên hệ thống. Vui lòng chuyển sang tab{" "}
                <strong>"2. Đối chiếu & Đánh giá chéo"</strong> để chấm bài cho bạn học và nhận điểm
                đánh giá của mình.
              </p>
            </div>
          </div>
        ...
        <div className='flex-grow flex flex-col gap-2 mt-2'>
          ...
          <textarea
            ...
            className={`w-full min-h-[320px] p-4 bg-bg-base/30 border rounded-xl outline-hidden focus:ring-1 focus:ring-primary focus:bg-white transition-all text-sm leading-relaxed text-neutral-dark font-sans ${
              isSubmitted
                ? "bg-slate-50 cursor-not-allowed border-slate-200"
                : "border-border-light/60 focus:border-primary"
            }`}
          />
        </div>
        ...
        <div className='flex justify-between items-center pt-4 border-t border-slate-100'>
          <span className='text-xs text-neutral-medium font-semibold'>
            Số lượng từ:{" "}
            <strong className={wordCount >= 250 ? "text-success" : "text-secondary"}>
              {wordCount}
            </strong>{" "}
            từ
          </span>
          ...
          >
            {isSubmitted ? "Đã nộp bài" : "Nộp bài viết"}
          </Button>
        </div>
      </div>
      ...
      <div className='lg:col-span-4 flex flex-col gap-6'>
              ...
              <>
                ...
                <div className='flex flex-col gap-1.5'>
                  <div className='flex justify-between items-center text-xs font-bold'>
                    <span className='text-success'>Đã hoàn thành bài viết</span>
                ...
                <div className='mt-2 p-3 bg-white rounded-lg border border-slate-100 flex items-start gap-2.5'>
                  ...
                  <p className='text-xs text-neutral-medium leading-relaxed'>
                    Bạn cùng tiến đã nộp bài tập. Hãy chuyển sang Tab tiếp theo để thực hiện chấm
                    chéo!
                  </p>
                </div>
              </>
              ...
              <>
                <div className='flex items-center gap-4'>
                  <Avatar
                    src={null}
                    alt='Bạn cùng tiến'
                    className='w-12 h-12 border-2 border-slate-200 bg-slate-100'
                  />
                  <div>
                    <h3 className='text-sm font-bold text-neutral-dark'>Bạn cùng tiến</h3>
                    <p className='text-xs text-neutral-medium mt-0.5'>Bạn đồng hành lớp học</p>
                  </div>
                </div>
                ...
                <div className='mt-2 p-3 bg-white rounded-lg border border-slate-100 flex items-start gap-2.5'>
                  <AlertCircle className='w-4 h-4 text-primary shrink-0 mt-0.5' />
                  <p className='text-xs text-neutral-medium leading-relaxed'>
                    Khi cả bạn và bạn cùng tiến đều nộp bài luận, hệ thống sẽ tự động ghép cặp và mở
                    khóa Tab chấm chéo.
                  </p>
                </div>
              </>
        ...
        <div className='bg-white rounded-2xl p-6 border border-border-light/30 shadow-xs flex-grow flex items-center justify-center relative overflow-hidden min-h-[200px]'>
          ...
          <div className='text-center z-10 flex flex-col items-center gap-3'>
            ...
            <h3 className='text-sm font-bold text-neutral-dark'>Học tập tương tác và chấm chéo</h3>
            <p className='text-xs text-neutral-medium max-w-[280px]'>
              EduSpace áp dụng phương pháp học tập kết hợp cặp đôi giúp tối ưu hiệu quả tiếp thu
              kiến thức và sửa lỗi nhanh chóng.
            </p>
          </div>
        </div>
      </div>
