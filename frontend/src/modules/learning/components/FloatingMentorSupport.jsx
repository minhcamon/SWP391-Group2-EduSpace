  ...
  return (
    <>
      <button
        ...
        className={`fixed bottom-6 transition-all duration-300 z-40 flex items-center justify-center w-14 h-14 rounded-full bg-secondary hover:bg-secondary/90 text-white shadow-xl hover:scale-105 active:scale-95 cursor-pointer group ${
          shiftLeft ? 'right-80 sm:right-[370px]' : 'right-6'
        }`}
