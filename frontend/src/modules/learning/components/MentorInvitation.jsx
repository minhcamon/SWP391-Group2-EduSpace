...
export const MentorInvitation = ({ isOpen, onClose, classId }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="w-full max-w-2xl bg-white dark:bg-card rounded-2xl overflow-hidden shadow-2xl p-0 gap-0 border border-slate-100 text-left" showCloseButton={false}>
        {/* Modal Header */}
        <header className="bg-neutral-dark p-8 flex flex-col items-center text-center">
          ...
          <DialogDescription className="sr-only">
            Lời mời ứng tuyển làm Mentor lớp học dựa trên kết quả học tập xuất sắc của bạn.
          </DialogDescription>
        </header>
