        ...
        <main className="flex-1 p-8 bg-bg-base overflow-y-auto">
          <div className="max-w-275 mx-auto space-y-8 animate-in fade-in duration-300">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <div className="relative">
                  <select
                    ...
                    className="appearance-none bg-white border border-border-light/40 pl-4 pr-10 py-2.5 rounded-xl text-xs font-semibold focus:ring-2 focus:ring-primary/20 outline-none cursor-pointer transition-all shadow-xs"
                  >
                    {courseOptions.map(c => (
                      <option key={c.id} value={c.id}>{c.name}</option>
                    ))}
                  </select>
                  <LuChevronDown className="absolute right-3.5 top-3.5 text-gray-400 pointer-events-none text-xs" />
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white p-5 rounded-2xl shadow-[0px_4px_20px_rgba(0,0,0,0.02)] border border-border-light/30 flex items-center gap-4 relative overflow-hidden group hover:shadow-[0px_10px_30px_rgba(79,70,229,0.05)] transition-all duration-300">
              ...
              {/* Card 2: Passed Count */}
              <div className="bg-white p-5 rounded-2xl shadow-[0px_4px_20px_rgba(0,0,0,0.02)] border border-border-light/30 flex items-center gap-4 relative overflow-hidden group hover:shadow-[0px_10px_30px_rgba(16,185,129,0.05)] transition-all duration-300">
              ...
              {/* Card 3: Failed Count */}
              <div className="bg-white p-5 rounded-2xl shadow-[0px_4px_20px_rgba(0,0,0,0.02)] border border-border-light/30 flex items-center gap-4 relative overflow-hidden group hover:shadow-[0px_10px_30px_rgba(239,68,68,0.05)] transition-all duration-300">
              ...
              {/* Card 4: Avg Score */}
              <div className="bg-white p-5 rounded-2xl shadow-[0px_4px_20px_rgba(0,0,0,0.02)] border border-border-light/30 flex items-center gap-4 relative overflow-hidden group hover:shadow-[0px_10px_30px_rgba(249,115,22,0.05)] transition-all duration-300">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-2xl border border-border-light/30 shadow-[0px_4px_20px_rgba(0,0,0,0.01)] col-span-2 space-y-4">
              ...
              <div className="bg-white p-6 rounded-2xl border border-border-light/30 shadow-[0px_4px_20px_rgba(0,0,0,0.01)] space-y-6 flex flex-col justify-between">
                <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="bg-white p-6 rounded-2xl border border-border-light/30 shadow-[0px_4px_20px_rgba(0,0,0,0.01)] lg:col-span-5 space-y-4">
                <div>
              ...
              <div className="bg-white p-6 rounded-2xl border border-border-light/30 shadow-[0px_4px_20px_rgba(0,0,0,0.01)] lg:col-span-7 space-y-4">
                        ...
                        .map((std) => (
                          <tr key={std.id} className="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td className="py-3 pr-2 text-right">
                              <span className="px-2 py-0.5 rounded-md text-[9px] font-bold bg-red-50 text-red-600 border border-red-100">
                                {std.status}
                              </span>
                            </td>
                          </tr>
